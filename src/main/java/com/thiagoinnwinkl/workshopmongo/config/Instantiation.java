...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2022"), "Partiu viagem", "Vou viajar para SP", maria);
		Post post2 = new Post(null, sdf.parse("21/03/2022"), "Bom dia!", "Acordei feliz hoje!", maria);
